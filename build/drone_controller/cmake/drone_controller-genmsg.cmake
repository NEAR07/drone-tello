...
get_filename_component(_filename "/home/nizhar/drone/src/drone_controller/srv/SetRefPose.srv" NAME_WE)
add_custom_target(_drone_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "drone_controller" "/home/nizhar/drone/src/drone_controller/srv/SetRefPose.srv" ""
)

get_filename_component(_filename "/home/nizhar/drone/src/drone_controller/srv/MoveDroneW.srv" NAME_WE)
add_custom_target(_drone_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "drone_controller" "/home/nizhar/drone/src/drone_controller/srv/MoveDroneW.srv" ""
)
